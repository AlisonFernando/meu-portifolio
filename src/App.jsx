...
import DataTerrain from "./components/DataTerrain";
...
const PROFILE = {
  ...
  role: "Desenvolvedor Full Stack Pleno | Data & BI Analyst",
  ...
  highlights: [
    ...
    "20+ fontes de dados via web scraping",
    "Redução de até 90% no tempo de rotinas",
    "Dashboards e produtos ponta a ponta",
  ],

  skills: {
    frontend: ["React", "JavaScript", "TypeScript", "UI/UX"],
    backend: ["Node.js", "Python", "PHP", "C#"],
    databases: ["PostgreSQL", "MySQL", "SQL Server", "MongoDB"],
    data: ["Pandas", "Business Intelligence", "Chart.js"],
    tools: ["Web Scraping (Selenium)", "APIs REST", "Insomnia", "Git"],
  },
...
const PROJECTS = [
  {
    title: "AgendaOcorte",
    blurb:
      "SaaS de agendamento online para barbearias: cliente marca o horário sozinho pelo celular, recebe confirmação automática e pode remarcar por um link próprio. O barbeiro acompanha agenda e faturamento em um painel instalável, como um app.",
    stack: ["Sistema Web", "PWA", "Dashboard", "Agendamento"],
    image:
      "https://images.unsplash.com/photo-1605497788116-1f20ad55ea7f?q=80&w=1200&auto=format&fit=crop",
    live: "https://www.agenda-o-corte.com.br/",
    repo: "#",
    impact:
      "Produto completo entregue de ponta a ponta: da concepção ao painel de métricas em produção",
  },
  {
...
const TIMELINE = [
  {
    role: "Analista de Sistemas (Full Stack Pleno)",
    company: "Scot Consultoria",
    period: "2023 — atual",
    location: "Bebedouro • SP",
    bullets: [
      "Desenvolvimento e manutenção de 20+ APIs REST integrando dados de diferentes commodities e fontes, consumidas por clientes e sistemas internos",
      "Engenharia de web scraping (Selenium/WebDriver) para coleta automatizada de mais de 20 fontes de dados de preços e indicadores do agronegócio",
      "Redução de até 90% no tempo de rotinas diárias de coleta, estruturação e entrega de dados (de 1–3h para 10–20min), via automação em Python",
      "Construção de plataformas de exibição de preços e dashboards analíticos com Pandas, BI e Chart.js, com UI/UX planejada e responsiva",
      "Liderança técnica em projetos de dashboards, estudos e apresentações para clientes, coordenando múltiplas pessoas e times",
      "Testes e validação de APIs com Insomnia, garantindo integrações confiáveis com clientes",
      "Refatoração e manutenção de sistemas legados em PHP, com foco em performance e organização de código",
    ],
    tech: [
      "PHP",
      "JS",
...
export default function Portfolio() {
  ...
  return (
    ...
    >
      {/* Fundo 3D: terreno de dados animado (Three.js) */}
      {!prefersReduced && <DataTerrain />}
      ...
      {/* Glow de fundo (atmosfera sobre o terreno 3D) */}
